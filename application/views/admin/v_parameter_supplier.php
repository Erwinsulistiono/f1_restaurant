...
<div id="base">
  ...
  <div id="content">
    ...
    <section class="style-default-bright" style="margin-top:0px;">
      <p><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_supplier"><span
              ...
              <tr>
                ...
                <td class="text-right">
                  <a href="#" class="btn btn-icon-toggle" title="Edit row" data-toggle="modal"
                    data-target="#modal_edit_supplier<?= $table_content['supplier_id']; ?>"><i class="fa fa-pencil"></i></a>
...
<div class="modal fade" id="modal_add_supplier" tabindex="-1" role="dialog" aria-labelledby="largeModal"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post" action="<?= base_url('admin/parameter/simpan_supplier'); ?>"
        enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">Kode Supplier</label>
            <div class="col-sm-8">
              <input name="supplier_kode" class="form-control" id="regular13" required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">Nama Supplier</label>
            <div class="col-sm-8">
              <input name="supplier_nama" class="form-control" id="regular13" required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">Alamat</label>
            <div class="col-sm-8">
              <input name="supplier_alamat" class="form-control" id="regular13" required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">Telepon</label>
            <div class="col-sm-8">
              <input name="supplier_telp" class="form-control" id="regular13" required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">Email</label>
            <div class="col-sm-8">
              <input name="supplier_email" class="form-control" id="regular13" required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">PIC</label>
            <div class="col-sm-8">
              <input type="supplier_pic" name="" class="form-control" id="regular13" required>
            </div>
          </div>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input name="supplier_kode" value="<?= $table_content['supplier_kode']; ?>" class="form-control" id="regular13"
                required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">Nama Supplier</label>
            <div class="col-sm-8">
              <input name="supplier_nama" value="<?= $table_content['supplier_nama']; ?>" class="form-control" id="regular13"
                required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">Alamat</label>
            <div class="col-sm-8">
              <input name="supplier_alamat" value="<?= $table_content['supplier_alamat']; ?>" class="form-control" id="regular13"
                required>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="supplier_telp" value="<?= $table_content['supplier_telp']; ?>" class="form-control" id="regular13"
                required>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="supplier_email" value="<?= $table_content['supplier_email']; ?>" class="form-control" id="regular13"
                required>
            </div>
          </div>
          <div class="form-group">
            <label for="regular13" class="col-sm-3 control-label">PIC</label>
            <div class="col-sm-8">
              <input name="supplier_pic" value="<?= $table_content['supplier_pic']; ?>" class="form-control" id="regular13"
                required>
            </div>
          </div>
...
<div class="modal fade" id="modal_hapus_supplier<?= $table_content['supplier_id']; ?>" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post" action="<?= base_url('admin/parameter/hapus_supplier'); ?>"
        enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
