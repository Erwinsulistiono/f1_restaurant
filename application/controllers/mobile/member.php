...
class Member extends CI_Controller
{
        ...
        if (!empty($_FILES['filefoto']['name'])) {
            if ($this->upload->do_upload('filefoto')) {
                ...
                if ($pass <> $pass2) {
                    ...
                    $this->m_parameter->simpan_pelanggan_dengan_gambar($nama, $alamat, $jenkel, $kontak, $email, $facebook, $instagram, $line, $whatapp, $path, $pass, $gambar);
            ...
            if ($pass <> $pass2) {
                ...
                $this->m_parameter->simpan_pelanggan_tanpa_gambar($nama, $alamat, $jenkel, $kontak, $email, $facebook, $instagram, $line, $whatapp, $path, $pass);
                echo $this->session->set_flashdata('msg', '<div class="notifications success">Data <b>' . $nama . '</b> Berhasil di simpan ke database.</div>');
                redirect('mobile/member');
            }
        }
    ...
    function auth()
    {
        ...
        $u = $username;
        $p = $password;
        $cadmin = $this->m_parameter->cek_pelanggan($u, $p);
